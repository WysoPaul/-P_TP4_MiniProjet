...
#define SDRAM_TIMEOUT			((unsigned int)0xFFFF)


/* SDRAM start address = FMC peripheral start address */
#define SDRAM_START_ADR			(unsigned int)0xD0000000
/* SDRAM max memory width = 8MB */
#define SDRAM_MEMORY_WIDTH		(unsigned int)0x800000
/* Timeout for SDRAM initialization */
#define SDRAM_TIMEOUT			((unsigned int)0xFFFF)
/**
...
//Offset for Layer 2
#define LTDC_FRAME_OFFSET		(unsigned int)SCREEN_PIXEL * 2
