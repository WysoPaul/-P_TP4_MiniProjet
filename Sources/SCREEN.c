...
#include "SCREEN.h"
// version 5 du 16/07/2018


// global variable for SCREEN
unsigned short int SCREEN_x;
...
//void SCREEN_DrawPixel(unsigned short int x, unsigned short int y, unsigned int color) {
void SCREEN_DrawPixel(unsigned short int x, unsigned short int y, unsigned int color) {
	...
	if (SCREEN_Configs.Orient == SCREEN_Orientation_Portrait_1) {
		//Portrait1
		*(unsigned short int *) (SCREEN_FRAME_BUFFER + SCREEN_Configs.CurrentLayerOffset + 2 * (SCREEN_PIXEL - x - SCREEN_Configs.Width * y)) = color;
	} else if (SCREEN_Configs.Orient == SCREEN_Orientation_Portrait_2) {
		//Portrait2, original
		*(unsigned short int *) (SCREEN_FRAME_BUFFER + SCREEN_Configs.CurrentLayerOffset + 2 * (x + SCREEN_Configs.Width * y)) = color;
	} else if (SCREEN_Configs.Orient == SCREEN_Orientation_Landscape_1) {
		//landscape1
		tmp = x;
		x = y;
		y = SCREEN_HEIGHT - 1 - tmp;
		*(unsigned short int *) (SCREEN_FRAME_BUFFER + SCREEN_Configs.CurrentLayerOffset + 2 * (x + SCREEN_WIDTH * y)) = color;
	} else {
		//Landscape2
		tmp = y;
		y = x;
...
void SCREEN_DrawLine(unsigned short int x0, unsigned short int y0, unsigned short int x1, unsigned short int y1, unsigned int color) {
	
	short int dx, dy, sx, sy, err, e2;
...
void SCREEN_DrawFilledRectangle(unsigned short int x0, unsigned short int y0, unsigned short int x1, unsigned short int y1, unsigned int color) {
	for (; y0 <= y1; y0++) {
...
void SCREEN_DrawRectangle(unsigned short int x0, unsigned short int y0, unsigned short int x1, unsigned short int y1, unsigned int color) {
...
//void SCREEN_putc(unsigned short int x, unsigned short int y, char c, SCREEN_FontDef_t *font, unsigned int foreground, unsigned int background) {
void SCREEN_putc(unsigned short int x, unsigned short int y, char c, SCREEN_FontDef_t *font, unsigned int foreground, unsigned int background){
	unsigned int i, b, j;
	/* Set coordinates */
	SCREEN_x = x;
...
//void SCREEN_Puts(unsigned short int x, unsigned short int y, char *str, SCREEN_FontDef_t *font, unsigned int foreground, unsigned int background) {
void SCREEN_Puts(unsigned short int x, unsigned short int y, char *str, SCREEN_FontDef_t *font, unsigned int foreground, unsigned int background) {
	unsigned short int startX = x;
...
/**********************************************************/
unsigned char SCREEN_SDRAM_Init(void) {
...
/**********************************************************/
unsigned char SCREEN_SPI_Send(unsigned char data) {
...
void SCREEN_LCD_SendCommand(unsigned char data) {
	SCREEN_WRX_RESET;
	SCREEN_CS_RESET;
...
void SCREEN_LCD_SendData(unsigned char data) {
	SCREEN_WRX_SET;
	SCREEN_CS_RESET;
	SCREEN_SPI_Send(data);
	SCREEN_CS_SET;
...
void SCREEN_Fill(unsigned int color) {
	unsigned int i;
	unsigned int pixels = SCREEN_PIXEL * 2;
	for (i = 0; i < pixels; i += 2) {
		*(unsigned short int *) (SCREEN_FRAME_BUFFER + SCREEN_Configs.CurrentLayerOffset + i) = color;
	}
}
// SCREEN_Config
void SCREEN_Config(){
